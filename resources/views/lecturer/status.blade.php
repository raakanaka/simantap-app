    ...
    <div class="w-64 bg-white shadow-lg">
        ...
        <nav class="mt-6">
            <div class="px-4 space-y-2">
                ...
                <a href="{{ route('lecturer.status') }}" class="w-full flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-700 transition duration-200 bg-blue-50 text-blue-700">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        <header class="bg-white shadow-sm border-b border-gray-200">
            <div class="px-6 py-4">
                ...
                <p class="text-gray-600">Monitor status pengajuan ujian akhir yang telah diverifikasi</p>
            </div>
        </header>
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        ...
                        <p class="text-gray-600 text-sm mb-4">Pengajuan yang masih dalam proses verifikasi</p>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <div class="flex items-center justify-between mb-4">
                            <h3 class="text-lg font-medium text-gray-900">Berkas Diterima</h3>
                        ...
                        <a href="{{ route('lecturer.submissions') }}?status=berkas_diterima" class="w-full bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-4 rounded-lg transition duration-200 inline-flex items-center justify-center">
                            <i class="fas fa-check mr-2"></i>Lihat Detail
                        </a>
                    </div>
                    
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <div class="flex items-center justify-between mb-4">
                            <h3 class="text-lg font-medium text-gray-900">Berkas Ditolak</h3>
                        ...
                        <a href="{{ route('lecturer.submissions') }}?status=berkas_ditolak" class="w-full bg-red-600 hover:bg-red-700 text-white font-medium py-2 px-4 rounded-lg transition duration-200 inline-flex items-center justify-center">
                            <i class="fas fa-times mr-2"></i>Lihat Detail
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm">
                    <div class="px-6 py-4 border-b border-gray-200">
                        ...
                        <p class="text-sm text-gray-600">Daftar pengajuan terbaru yang perlu diperhatikan</p>
                    </div>
